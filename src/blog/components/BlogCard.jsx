...
export default function BlogCard({ post, index = 0, view = "grid" }) {
  ...
  return (
    <article
      ...
      className="border border-black/15 bg-white mb-5 group overflow-hidden break-inside-avoid"
    >
      <Link to={`/blog/post/${post.id}`} state={{ background: location }}>
        ...
        {youtubeId && (
          <div className="relative w-full" style={{ paddingBottom: "56.25%" }}>
            ...
            <div className="absolute inset-0 flex items-center justify-center bg-black/10 group-hover:bg-black/20 transition-colors">
              <div className="w-14 h-14 bg-red-600/90 flex items-center justify-center shadow-xl">
        ...
        {/* Cover photo — natural height, no crop */}
        ...
        {/* Mp4 video */}
        {!youtubeId && !post.cover && post.video && (
          <video className="w-full h-auto block" preload="metadata">
            <source src={post.video} type="video/mp4" />
          </video>
        )}

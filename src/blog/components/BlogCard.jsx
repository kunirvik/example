        ...
        <div className="p-4 border-t border-black/10">
          <div className="flex items-center gap-2 mb-2">
            ...
            {post.tags?.slice(0, 2).map(t => (
              <span key={t} className="text-[10px] font-black tracking-widest uppercase text-black/45 border-l border-black/20 pl-2">
                #{t}
              </span>
            ))}
          </div>
          ...
          {post.excerpt && (
            <p className="mt-2 text-sm text-black/55 font-['EB_Garamond'] leading-relaxed line-clamp-3">
              {post.excerpt}
            </p>
          )}
          <div className="mt-3 pt-3 border-t border-dashed border-black/15 flex items-center justify-between">
            ...
            <span className="text-xs font-black tracking-widest text-black group-hover:translate-x-1 transition-transform inline-block">
              READ →
            </span>
          </div>
        </div>

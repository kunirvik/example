  ...
  return (
    <a href={`/blog/post/${post.id}`}
      ...
      <div className="flex-1 min-w-0">
        <p className="text-[12px] font-futura font-bold text-white/80 leading-tight group-hover:text-[#ffe600] transition-colors line-clamp-2">
          {post.title}
        </p>
  ...
  if (loading) return (
    <div className="min-h-screen bg-[#0a0a0a] flex items-center justify-center">
      <div className="flex flex-col items-center gap-3">
        ...
        <span className="font-futura text-white/40 text-sm">Loading...</span>
      </div>
    </div>
  )
  if (error) return (
  ...
  return (
    <PostsContext.Provider value={filtered}>
      ...
      <div className="min-h-screen bg-[#0a0a0a]">
        ...
        {/* ── Top bar ──────────────────────────────────────────────────────── */}
        <div className="bg-[#1a1a1a] border-b-2 border-[#ffe600]">
          <div className="max-w-[1200px] mx-auto px-4 h-12 md:h-14 flex items-center gap-3 md:gap-4 flex-wrap md:flex-nowrap">
            ...
            {/* Tag filters - горизонтальный скролл на мобильных */}
            ...
            <form onSubmit={submitSearch} className="flex-shrink-0 w-full md:w-auto mt-2 md:mt-0">
              <div className="flex border border-white/20 overflow-hidden h-8">
                ...
                <button
                  type="submit"
                  className="px-3 bg-[#ffe600] text-[#111] font-futura font-bold text-[11px] uppercase tracking-wide hover:bg-[#ffe600]/90 transition-colors flex-shrink-0">
                  Go
                </button>
              </div>
            </form>
              ...
              {(activeTag !== "all" || search) && (
                <div className="flex items-center gap-2 mb-3 bg-white/[0.03] border border-white/[0.08] px-3 py-2">
                  ...
                  <button
                    ...
                    className="ml-auto text-[11px] text-[#ffe600] font-futura font-bold hover:underline cursor-pointer">
                    Clear ✕
                  </button>
                </div>
              )}
            ...
            <aside className="w-full lg:w-[260px] flex-shrink-0 hidden lg:flex flex-col gap-3 lg:sticky lg:top-4">
              ...
              <div className="bg-[#111] border border-white/[0.08] shadow-sm">
                <div className="bg-[#1a1a1a] px-3 py-2 flex items-center gap-2">
                  <div className="w-2 h-2 bg-[#ffe600]" />
              ...
              <div className="bg-[#111] border border-white/[0.08] shadow-sm px-4 py-3">
                ...
                {activeTag !== "all" && (
                  <p className="font-futura text-[12px] text-white/40 mt-1">
                    <span className="font-bold text-[#ffe600]">{filtered.length}</span> in #{activeTag}
                  </p>
                )}
              </div>

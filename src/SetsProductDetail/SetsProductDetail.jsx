...
// // НОВЫЕ ИМПОРТЫ - КОНСТАНТЫ И УТИЛИТЫ
// import { ANIMATION_CONFIG, SWIPER_CONFIG, LOADING_SCREEN_DURATION } from "../Constants";
// import { useOpenGallery } from "../useOpenGallery";

// // ============================================================================
// // ГЛАВНЫЙ КОМПОНЕНТ (ПОСЛЕ РЕФАКТОРИНГА)
// // ============================================================================
...
//     registerImageRef,
//     imageRefsMap
//   } = useHoverAnimation(isTouchDevice, getIntervalDuration);
...
//     showInfoAndThumbs
//   } = useSlideAnimation(imageData);

//   const {
//     accordionState,
//     setAccordionState,
//     handleAccordionToggle: handleAccordionToggleBase
//   } = useProductAccordion();
...
//   // ─── Utilities ───────────────────────────────────────────────────────
//   function getIntervalDuration(totalImages) {
...
//     (index, product) => {
//       if (isTouchDevice || !animationState.complete || animationState.inProgress) return;
//       updateState({ hoveredIndex: index });
//       startHoverAnimation(index, product, state.selectedImageIndices[index] || 0);
//     },
//     [
//       isTouchDevice,
...
//     stopHoverAnimation();
//   }, [stopHoverAnimation, updateState]);
...
//         return;
//       }
//       handleAccordionToggleBase(type)(index);
//     },
//     [handleAccordionToggleBase, state.activeProductIndex, openGallery, setAccordionState]
//   );
...
//       if (
//         newIndex === state.activeProductIndex ||
...
//     },
//     [state.activeProductIndex, swiperInstances.main, animationInProgressRef]
//   );
...
//             {/* ── КОМПОНЕНТ: Переходное изображение ────────────────── */}
...
//               animationComplete={animationState.complete}
